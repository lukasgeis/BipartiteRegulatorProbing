...
do
    target/release/bpr --log "${OUTPUTDIR}/max/OUT_${NUM}" --na $((16 * $NUM)) --nb $((400 * $NUM)) --vs 10 --iterations 500 --instances 10 --goal MAX --algorithm ALL --parameters 4 --poisson &
    target/release/bpr --log "${OUTPUTDIR}/sum/OUT_${NUM}" --na $((16 * $NUM)) --nb $((400 * $NUM)) --vs 10 --iterations 500 --instances 10 --goal SUM --algorithm ALL --parameters 4 --poisson &
